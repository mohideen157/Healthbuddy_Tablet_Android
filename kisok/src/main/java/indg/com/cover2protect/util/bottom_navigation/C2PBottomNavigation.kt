...
internal typealias IBottomNavigationListener = (model: C2PBottomNavigation.Model) -> Unit

@Suppress("MemberVisibilityCanBePrivate")
class C2PBottomNavigation : FrameLayout {

    var models = ArrayList<Model>()
    var cells = ArrayList<C2PBottomNavigationCell>()
    ...
    private fun initializeViews() {
        ...
        bezierView.apply {
            ...
            shadowColor = this@C2PBottomNavigation.shadowColor
        }
    ...
    fun add(model: Model) {
        val cell = C2PBottomNavigationCell(context)
        cell.apply {
            val params = LinearLayout.LayoutParams(0, heightCell, 1f)
            layoutParams = params
            icon = model.icon
            count = model.count
            circleColor = this@C2PBottomNavigation.backgroundBottomColor
            countTextColor = this@C2PBottomNavigation.countTextColor
            countBackgroundColor = this@C2PBottomNavigation.countBackgroundColor
            countTypeface = this@C2PBottomNavigation.countTypeface
            rippleColor = this@C2PBottomNavigation.rippleColor
            defaultIconColor = this@C2PBottomNavigation.defaultIconColor
            selectedIconColor = this@C2PBottomNavigation.selectedIconColor
            onClickListener = {
    ...
    private fun anim(cell: C2PBottomNavigationCell, id: Int, enableAnimation: Boolean = true) {
        isAnimating = true
    ...
    fun getCellById(id: Int): C2PBottomNavigationCell? {
    ...
    class Model(var id: Int, var icon: Int) {
        ...
        var count: String = C2PBottomNavigationCell.EMPTY_VALUE
