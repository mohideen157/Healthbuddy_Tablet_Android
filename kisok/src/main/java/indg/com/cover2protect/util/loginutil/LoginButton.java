...
import indg.com.cover2protect.presenter.OnButtonSwitchedListener;
import indg.com.cover2protect.presenter.OnLoginListener;
import indg.com.cover2protect.presenter.OnSignUpListener;
...
public class LoginButton extends View {
    ...
    private void init() {
        ...
        loginPaint.setTextSize(dpToPixels(0));
...
//        signUpPaint.setAlpha(255);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        currentLoginX = dpToPixels(80);
        int signUpWidth = r.right;
        currentSignUpTextX = width - signUpWidth / 2 - dpToPixels(40);
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (isLogin) {
                    ...
                    signUpPaint.setAlpha(255);
                    signUpPaint.setTextSize(dpToPixels(0));
                }
