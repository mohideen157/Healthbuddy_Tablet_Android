...
public class BadgeHolderLayout extends ViewGroup implements BadgeCounter {
    ...
    private void measureImageViewChild(int width, int height) {
        ...
        int viewSquareSpec = MeasureSpec.makeMeasureSpec((int) (Math.max(width, height) * ConstKt.VIEW_SCALE_FACTOR), MeasureSpec.EXACTLY);
    ...
    private void measureBadgeView(int width, int height) {
        ...
        int badgeHeightSpec = MeasureSpec.makeMeasureSpec((int)(height * .5f * ConstKt.VIEW_SCALE_FACTOR), MeasureSpec.EXACTLY);
