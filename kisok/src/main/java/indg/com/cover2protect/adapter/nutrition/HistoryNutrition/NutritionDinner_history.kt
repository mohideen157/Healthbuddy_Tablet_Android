...
class NutritionDinner_history(private var context: Context, private var response: List<Date>) : androidx.recyclerview.widget.RecyclerView.Adapter<NutritionDinner_history.CustomViewHolder>() {
