...
class NutritionSnack_history(private var context: Context, private var response: List<Date>) : androidx.recyclerview.widget.RecyclerView.Adapter<NutritionSnack_history.CustomViewHolder>() {
