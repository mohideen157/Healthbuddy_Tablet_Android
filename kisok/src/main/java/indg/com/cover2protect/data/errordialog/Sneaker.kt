...
import indg.com.cover2protect.presenter.OnSneakerClickListener
import indg.com.cover2protect.presenter.OnSneakerDismissListener
...
class Sneaker(private var context: Context) : View.OnClickListener, LifecycleObserver {
    ...
    private var mListener: indg.com.cover2protect.presenter.OnSneakerClickListener? = null
    private var mDismissListener: indg.com.cover2protect.presenter.OnSneakerDismissListener? = null
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun with(fragment: androidx.fragment.app.Fragment): Sneaker {
    ...
    private fun setTargetView(targetView: Any) {
        this.targetView =
                when (targetView) {
                    ...
                    is androidx.fragment.app.Fragment -> targetView.view as ViewGroup
     ...
     * @return
     */
    fun setOnSneakerClickListener(listener: indg.com.cover2protect.presenter.OnSneakerClickListener): Sneaker {
        mListener = listener
        return this
    }
     ...
     */
    fun setOnSneakerDismissListener(listener: indg.com.cover2protect.presenter.OnSneakerDismissListener): Sneaker {
     ...
     */
    fun sneakWarning() {
        mBackgroundColor = Color.parseColor("#3eadeb")
