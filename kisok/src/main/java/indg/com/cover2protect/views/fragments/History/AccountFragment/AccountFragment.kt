...
import indg.com.cover2protect.base.BaseFragment
import indg.com.cover2protect.base.BaseFragmentBinding
import indg.com.cover2protect.databinding.FragmentAccountBinding
 ...
 */
class AccountFragment : BaseFragmentBinding<FragmentAccountBinding>(), View.OnClickListener {
    ...
    private val mServiceCallback = object : IServiceCallback.Stub() {
        ...
        override fun onReceiveSensorData(arg0: Int, arg1: Int, arg2: Int, arg3: Int,
                                         arg4: Int) {
            binding!!.heartrate.setStepCountText(arg1.toString()+"/"+arg2.toString())
        }
