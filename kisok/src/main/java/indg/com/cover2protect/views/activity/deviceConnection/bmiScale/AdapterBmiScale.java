 ...
 *
 */
public class AdapterBmiScale extends ArrayAdapter{

	 private ArrayList<LsDeviceInfo> modelsArrayList;
	  private Context context;

	  @SuppressWarnings("unchecked")
	public AdapterBmiScale(Context context, ArrayList<LsDeviceInfo> modelsArrayList) {
		
	         super(context, R.layout.adapter_bmi_scan_list_item, modelsArrayList);
   ...
   public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       {
       	     rowView =inflater.inflate(R.layout.adapter_bmi_scan_list_item, parent, false);
