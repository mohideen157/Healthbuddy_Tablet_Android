...
import indg.com.cover2protect.views.activity.deviceConnection.bmiScale.PairedBmiListFragment
import kotlinx.android.synthetic.main.adapter_bp_history.view.*
import java.util.*


class RViewAdapterBMIHistory(
        private val mValues: ArrayList<W3Obj>,
        private val context: Context,
        val  showParingFragment: PairedBmiListFragment.showParingFragment)
    : RecyclerView.Adapter<RViewAdapterBMIHistory.ViewHolder>() {
    ...
    init {
        mOnClickListener = View.OnClickListener { v ->
            ...
            showParingFragment.onClickParing(item)
