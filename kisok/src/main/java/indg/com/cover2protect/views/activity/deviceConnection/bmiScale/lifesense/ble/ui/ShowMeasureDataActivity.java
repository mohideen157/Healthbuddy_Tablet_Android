...
public class ShowMeasureDataActivity extends Base2Activity {

	private TextView showTextView, tvWeightHeader,tvBmiHeader,
			tvTarget,tvLose,tvBodyFat,tvMuscleMass,
			tvViserialFat,tvBodyWater,tvBoneMass,tvBmi;
	...
	/*	tvBmiHeader = findViewById(R.id.tv_bmi_chart_bmi_header);
		tvWeightHeader = findViewById(R.id.tv_bmi_chart_weight_header);
		tvTarget = findViewById(R.id.tv_bmi_chart_target_weight);
		tvLose = findViewById(R.id.tv_bmi_chart_weight_to_lose);
		tvBodyFat = findViewById(R.id.tv_bmi_chart_body_fat);
		tvMuscleMass = findViewById(R.id.tv_bmi_chart_muscle_mass);
		tvViserialFat = findViewById(R.id.tv_bmi_chart_visceral_fat);
		tvBodyWater = findViewById(R.id.tv_bmi_chart_body_water);
		tvBoneMass = findViewById(R.id.tv_bmi_chart_bone_mass);
		tvBmi = findViewById(R.id.tv_bmi_chart_bmr);*/
