...
import indg.com.cover2protect.databinding.FragmentDeviceBinding
 ...
 */
class DeviceFragment : BaseFragmentBinding<FragmentDeviceBinding>() {
    ...
    private val mServiceCallback = object : IServiceCallback.Stub() {
        ...
        override fun onGetCurSportData(type: Int, timestamp: Long, step: Int, distance: Int,
            ...
            binding!!.stepLine.setmValueText(step.toString())
            var cal = step * 36 / 1000
            binding!!.caloriesLine.setmValueText(cal)
